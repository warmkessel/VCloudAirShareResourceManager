...
%><?xml version="1.0" encoding="UTF-8"?>  <%
		...
		List<Users> usr =  DataServices.getUsersService().findRange(start, limit);
...
%>
	...
	<td>
	<a href="user.jsp?id=<%= usr.get(x).getId()%>"><%= usr.get(x).getId()%></a>
	</td><td>
...
Size: <%= usr.size()%><a href="user.jsp">New User</a>