...
public enum Status {
	UNKNOWN(0,"Unknown"), APPROVED(1,"Approved"), SUSPECT(2,"Suspect"), INVALID(3,"Invalid"), INACTIVE(4,"Inactive"), UNSUPPORTED(5,"Unsupported"),DUPLICATE(6,"Duplicate"),REMOVED(7,"Removed"),TEST(8,"Test"),AVAILABLE(9,"Available"),INUSE(10,"Inuse");
